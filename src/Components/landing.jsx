                ...
                isAuthenticated ? (
                    ...
                    <div className=" bg-[#f1f5f9]">
                        ...
                        <div className="  ">
                            ...
                            <div style={{backgroundImage: `url(${images[currentIndex]})`}} className=" group flex items-center flex-col h-screen w-full bg-no-repeat bg-cover bg-center duration-500">

                                <div className=" flex items-center flex-col mt-48 mb-48">
                                    <h1 className=" font-semibold text-lg text-[#f1f5f9]  " > Bienvenidos a: </h1>
                                    <h3 className=" text-6xl font-sans font-semibold text-[#f1f5f9] p-5 "> Viator </h3>
                            ...
                            <section className=" bg-gradient-to-r bg-transparent my-4 flex flex-wrap justify-center ">
                                <div className=" rounded-lg backdrop-blur-sm sm:pl-0 pl-0 ">
                                    <div className=" max-w-lg ">
                                        <h2 className=" flex justify-center  text-[#1d4ed8] text-[30px] font-semibold">Quienes Somos</h2>
                        ...
                        <div className=" flex justify-around flex-wrap  m-2 p-3 ">
                            ...
                            <section className=" rounded-lg bg-[#02122C] my-4 flex ">
                                <div className=" sm:pr-0 pr-0 flex">
                                    <div className=" flex flex-col items-center max-w-lg">
                                        <h2 className=" text-[#f1f5f9]  text-[30px] font-semibold">Misión</h2>
                                        <p className=" text-[#f1f5f9] p-3 text-[16px] font-semibold">
                            ...
                            <section className=" rounded-lg bg-[#02122C] my-4 flex flex-wrap ">
                                <div className=" sm:pl-0 pl-0 flex flex-initial ">
                                    <div className=" flex flex-col items-center max-w-lg">
                                        <h2 className=" text-[#f1f5f9] text-[30px] font-semibold">Visión</h2>
                                        <p className=" text-[#f1f5f9] p-3 text-[16px] font-semibold">
