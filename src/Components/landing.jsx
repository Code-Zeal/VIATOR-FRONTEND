    ...
    <div className=" bg-slate-800">
      <div className="  ">
        ...
        <div
          ...
          className=" group flex justify-center flex-col h-screen w-full bg-no-repeat bg-cover bg-center duration-500"
        >
          <div className=" flex justify-center flex-col mt-48 mb-48">
            ...
            <h3 className=" text-6xl font-sans font-semibold text-slate-200 p-5 ">
              {" "}
              Viator{" "}
            </h3>
        ...
        <section className=" bg-gradient-to-r justify-center bg-transparent my-4 flex flex-wrap ">
          <div className=" rounded-lg backdrop-blur-sm sm:pl-0  pl-0 flex justify-center ">
            <div className="  max-w-lg">
              <h2 className=" text-sky-600 text-[30px] font-semibold">
                Quienes Somos
              </h2>
      ...
      <div className=" flex justify-around flex-wrap  m-2 p-3 ">
        <section className=" rounded-lg bg-gradient-to-r from-cyan-500 to-blue-500 justify-end  my-4 flex ">
          <div className=" sm:pr-0 pr-0 flex">
            <div className=" max-w-lg">
              <h2 className=" text-slate-200 text-[30px] font-semibold">
                Misión
              </h2>
              <p className=" p-3 text-[16px] font-semibold">
                Ofrecer el mejor servicio con el fin de alcanzar la satisfacción
                de nuestros usuarios con nuestros paquetes turísticos y
                boleteria aérea a precios accesibles para el disfrute en familia
                o empresarial.
              </p>
            </div>
          </div>
        ...
        <section className=" rounded-lg bg-gradient-to-r from-cyan-500 to-blue-500 my-4 flex flex-wrap ">
          <div className=" sm:pl-0 pl-0 flex flex-initial ">
            <div className="max-w-lg">
              ...
              <p className=" p-3 text-[16px] font-semibold">
                Consolidarnos como una agencia líder en el mercado actual, con
                personal calificado brindando una experiencia agradable a
                nuestros clientes, ademas fortalecer el turismo nacional y
                internacional
              </p>
            </div>
          </div>
